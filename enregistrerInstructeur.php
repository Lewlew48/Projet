            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="ui-widget">
                        ...
                        <form action="inc/enregistrementInstructeur.inc.php" method="post">
                            <fieldset>
                                <!-- Légende -->
                                ...
                                <!-- Zone de saisie -->
                                <input type="text" name="prenom" required maxlength="40"><br>
                                <label for='identifiant'>Identitifant</label>
                                <!-- Zone de saisie -->
                                <input type="text" name="identifiant" required maxlength="20"><br>
                                ...
                                <label>
                                    <!-- Sélectionde la direction -->
                                    <select name="direction" size="1">
                                        <?php
                                        foreach ($directions as $direction) {
                                            echo "<option value='" . $direction['id_Di'] . "'>" . $direction['nom_Di'] . "</option>";
                                        } ?>
                                    </select>
                                </label>
                                <br>
