...
<div class="container-fluid">
    ...
    // Ajouter la condition libelle_Ar à la requête SQL
    ...
    // Ajouter la condition attributaire_Ar à la requête SQL
                        ...
                        if (empty($arretes)) {
                            ...
                            for ($i = ($limite - 50); $i < $limite; $i++) {
                                ...
                                if (isset($arretes[$i]) && $arretes[$i] != NULL) {
                                    ...
                                    echo '<tr>';
                                    echo '<td>' . $arrete['dateCreation'][2] . $arrete['dateCreation'][3] . '-' . sprintf("%04d", $arrete['id']) . '</td>'; // Affichage de la date de création avec l'ID de l'accord
                                    echo '<td>' . $arrete['dateCreation'] . '</td>'; // Affichage de la date de création
                                    echo '<td>' . $arrete['libelle'] . '</td>'; // Affichage du libellé
                                    echo '<td>' . $arrete['direction'] . '</td>'; // Affichage de la direction
                                    echo '<td>' . $arrete['instructeur'] . '</td>'; // Affichage de l'instructeur
                                    echo '<td>' . $arrete['attributaire'] . '</td>'; // Affichage de l'attributaire
