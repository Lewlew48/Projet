                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        try {
                            ...
                            for ($i = 0; $i < $qte; $i++) {
                                ...
                                $sql = "INSERT INTO convention (dateCreation_Co, libelle_Co, attributaire_Co, chapitre_Co, article_Co, divers_Co, montant_Co, annule_Co, prive_Co, id_In) VALUES (:date, :libelle, :attributaire, :chapitre, :article, :divers, :montant, :annule, :prive, :id_In)";
                                $stmt = $pdo->prepare($sql);
                    ...
                    <div class='container d-flex justify-content-center ajouter'>
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Bouton retour -->
                                <button><a href="../../conventions" class="btn_retour">Retour</a></button>
                            </div>
                        </form>
                    </div>
                </div>
