...
<div class="container-fluid">
    ...
    if (isset($_POST['id'])) {
        ...
        header("Location:../../arretes-et-decisions");
        exit();
    }

    require '../../../inc/cnx.inc.php';
    global $pdo;
    $sql = "SELECT * FROM arrete WHERE id_Ar =?";
        ...
        <div class="main-content container col-xl-9 col-sm-12 mb-3">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['titre'])) {
                try {
                    ...
                    $sql = "UPDATE arrete SET libelle_Ar = :libelle, attributaire_Ar = :attributaire, chapitre_Ar = :chapitre, article_Ar = :article, divers_Ar = :divers, montant_Ar = :montant, annule_Ar = :annule, prive_Ar = :prive WHERE id_Ar = :id_Ar";
                    $stmt = $pdo->prepare($sql);
            ...
            <div class='container d-flex justify-content-center ajouter'>
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="titre" value="<?php echo $arrete['libelle_Ar'] ?>" required
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <label>Attributaire / Bénéficiaire:</label>
                        <input type="text" name="attributaire" value="<?php echo $arrete['attributaire_Ar'] ?>"
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <label>
                        ...
                        <input type="number" name="montant" value="<?php echo $arrete['montant_Ar'] ?>" required
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <?php
                        if ($arrete['prive_Ar'] == 1) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="chapitre" value="<?php echo $arrete['chapitre_Ar'] ?>"
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <label>Article :</label>
                        <input type="text" name="article" value="<?php echo $arrete['article_Ar'] ?>"
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <label>Divers :</label>
                        <input type="text" name="divers" value="<?php echo $arrete['divers_Ar'] ?>"
                               class='form-control'>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id" value="<?php echo $arrete['id_Ar'] ?>">
