            ...
            <div class='container d-flex justify-content-center ajouter'>
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="montant" required value="<?php echo $accord['montantHT_Ac'] ?>"
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="codePostal" value="<?php echo $accord['codePostal_Ac'] ?>" required
                               class='form-control'>
                    </div>
                    <div class="form-group">
                        <label>
