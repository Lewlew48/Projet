...
if (isset($_SESSION['role']) && isset($_POST['id'])) {
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="montant" required
                                       value="<?php echo $marche['montantHT_Ma'] ?>"
                                       class='form-control'>
                                <label>
                            ...
                            <div class="form-group MinMax" id="MinMax">
                                ...
                                <label>
                                    <input type="number" step="0.01" name="montantMin"
                                           value=<?php echo $marche['montantMin_Ma'] ?> class='form-control'>
                                </label>
                                <label>
                                    Montant Max:
                                </label>
                                ...
                                <label>
                                    <input type="number" step="0.01" name="montantMax"
                                           value=<?php echo $marche['montantMax_Ma'] ?> class='form-control'>
                                </label>
                            </div>
                            <!-- Groupement d'éléments -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Zone de saisie -->
                                <input type="text" name="codePostal" value="<?php echo $marche['codePostal_Ma'] ?>"
                                       required
                                       class='form-control'>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="commune" id="commune" required
                                       class='form-control' value="<?php echo $marche['commune_Ma'] ?>">
                            </div>
                            <!-- Groupement d'éléments -->
                            <div class="form-group">
                                <label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="commentaires" id="commentaires" class='form-control'
                                       value="<?php echo $marche['commentaires_Ma'] ?>">
                            </div>
                            <!-- Groupement d'éléments -->
                            <div class="form-group">
                                <label class="requis">
