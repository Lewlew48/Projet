                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <table>
                                ...
                                $sql = "SELECT * FROM type_ac_ma order by id_Ty";
                                $result = $pdo->query($sql);

                                // Récupérer l'ID maximum
                                $sql = "SELECT MAX(id_Ty) FROM type_ac_ma order by id_Ty";
                                $resultat = $pdo->query($sql);

                                // Formulaire pour ajouter un élément
                                echo "<tr class='admin'><form method='POST' action='portal-factory/ajouter.php?type=Type_ac_ma'>";
                                ...
                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    echo "<tr><form method='POST' action='portal-factory/modifier.php?type=Type_ac_ma'>";
                                    echo "<td><input type='text' name='id' id='id' value='" . $row['id_Ty'] . "' readonly/></td>";
                                    echo '<td><input type="text" name="nom" id="nom" value="' . $row['nom_Ty'] . '" /></td>';
                                    echo '<td>
                                        ...
                                        <form method="post" action="../services-generaux/portal-factory/supprimer/supprimer.php?type=Type_ac_ma">
                                            <input type="hidden" name="id" value="' . $row['id_Ty'] . '">
